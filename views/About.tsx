      ...
      <div className="grid lg:grid-cols-[1.5fr_1fr] gap-20 items-start">
        ...
        <section>
          <header className="mb-12">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extralight tracking-tighter uppercase mb-8 text-contentDark dark:text-white leading-[1.1]">
              Silvino <br /> 
            ...
            <div className="space-y-8">
              {PROFILE_DATA.education.map((edu, idx) => (
                <div key={idx} className="border-l border-black/10 dark:border-white/10 pl-6 py-1">
                  ...
                  <h3 className="text-lg font-bold uppercase mt-1 leading-tight">{edu.degree}</h3>
